...
transpose_list = [
    ...
    'bert.bert.bert_encoder.layers.12.attention.attention.query_layer.weight',
    'bert.bert.bert_encoder.layers.12.attention.attention.key_layer.weight',
    'bert.bert.bert_encoder.layers.12.attention.attention.value_layer.weight',
    'bert.bert.bert_encoder.layers.12.attention.output.dense.weight',
    'bert.bert.bert_encoder.layers.12.intermediate.weight',
    'bert.bert.bert_encoder.layers.12.output.dense.weight',
    'bert.bert.bert_encoder.layers.13.attention.attention.query_layer.weight',
    'bert.bert.bert_encoder.layers.13.attention.attention.key_layer.weight',
    'bert.bert.bert_encoder.layers.13.attention.attention.value_layer.weight',
    'bert.bert.bert_encoder.layers.13.attention.output.dense.weight',
    'bert.bert.bert_encoder.layers.13.intermediate.weight',
    'bert.bert.bert_encoder.layers.13.output.dense.weight',
    'bert.bert.bert_encoder.layers.14.attention.attention.query_layer.weight',
    'bert.bert.bert_encoder.layers.14.attention.attention.key_layer.weight',
    'bert.bert.bert_encoder.layers.14.attention.attention.value_layer.weight',
    'bert.bert.bert_encoder.layers.14.attention.output.dense.weight',
    'bert.bert.bert_encoder.layers.14.intermediate.weight',
    'bert.bert.bert_encoder.layers.14.output.dense.weight',
    'bert.bert.bert_encoder.layers.15.attention.attention.query_layer.weight',
    'bert.bert.bert_encoder.layers.15.attention.attention.key_layer.weight',
    'bert.bert.bert_encoder.layers.15.attention.attention.value_layer.weight',
    'bert.bert.bert_encoder.layers.15.attention.output.dense.weight',
    'bert.bert.bert_encoder.layers.15.intermediate.weight',
    'bert.bert.bert_encoder.layers.15.output.dense.weight',
    'bert.bert.bert_encoder.layers.16.attention.attention.query_layer.weight',
    'bert.bert.bert_encoder.layers.16.attention.attention.key_layer.weight',
    'bert.bert.bert_encoder.layers.16.attention.attention.value_layer.weight',
    'bert.bert.bert_encoder.layers.16.attention.output.dense.weight',
    'bert.bert.bert_encoder.layers.16.intermediate.weight',
    'bert.bert.bert_encoder.layers.16.output.dense.weight',
    'bert.bert.bert_encoder.layers.17.attention.attention.query_layer.weight',
    'bert.bert.bert_encoder.layers.17.attention.attention.key_layer.weight',
    'bert.bert.bert_encoder.layers.17.attention.attention.value_layer.weight',
    'bert.bert.bert_encoder.layers.17.attention.output.dense.weight',
    'bert.bert.bert_encoder.layers.17.intermediate.weight',
    'bert.bert.bert_encoder.layers.17.output.dense.weight',
    'bert.bert.bert_encoder.layers.18.attention.attention.query_layer.weight',
    'bert.bert.bert_encoder.layers.18.attention.attention.key_layer.weight',
    'bert.bert.bert_encoder.layers.18.attention.attention.value_layer.weight',
    'bert.bert.bert_encoder.layers.18.attention.output.dense.weight',
    'bert.bert.bert_encoder.layers.18.intermediate.weight',
    'bert.bert.bert_encoder.layers.18.output.dense.weight',
    'bert.bert.bert_encoder.layers.19.attention.attention.query_layer.weight',
    'bert.bert.bert_encoder.layers.19.attention.attention.key_layer.weight',
    'bert.bert.bert_encoder.layers.19.attention.attention.value_layer.weight',
    'bert.bert.bert_encoder.layers.19.attention.output.dense.weight',
    'bert.bert.bert_encoder.layers.19.intermediate.weight',
    'bert.bert.bert_encoder.layers.19.output.dense.weight',
    'bert.bert.bert_encoder.layers.20.attention.attention.query_layer.weight',
    'bert.bert.bert_encoder.layers.20.attention.attention.key_layer.weight',
    'bert.bert.bert_encoder.layers.20.attention.attention.value_layer.weight',
    'bert.bert.bert_encoder.layers.20.attention.output.dense.weight',
    'bert.bert.bert_encoder.layers.20.intermediate.weight',
    'bert.bert.bert_encoder.layers.20.output.dense.weight',
    'bert.bert.bert_encoder.layers.21.attention.attention.query_layer.weight',
    'bert.bert.bert_encoder.layers.21.attention.attention.key_layer.weight',
    'bert.bert.bert_encoder.layers.21.attention.attention.value_layer.weight',
    'bert.bert.bert_encoder.layers.21.attention.output.dense.weight',
    'bert.bert.bert_encoder.layers.21.intermediate.weight',
    'bert.bert.bert_encoder.layers.21.output.dense.weight',
    'bert.bert.bert_encoder.layers.22.attention.attention.query_layer.weight',
    'bert.bert.bert_encoder.layers.22.attention.attention.key_layer.weight',
    'bert.bert.bert_encoder.layers.22.attention.attention.value_layer.weight',
    'bert.bert.bert_encoder.layers.22.attention.output.dense.weight',
    'bert.bert.bert_encoder.layers.22.intermediate.weight',
    'bert.bert.bert_encoder.layers.22.output.dense.weight',
    'bert.bert.bert_encoder.layers.23.attention.attention.query_layer.weight',
    'bert.bert.bert_encoder.layers.23.attention.attention.key_layer.weight',
    'bert.bert.bert_encoder.layers.23.attention.attention.value_layer.weight',
    'bert.bert.bert_encoder.layers.23.attention.output.dense.weight',
    'bert.bert.bert_encoder.layers.23.intermediate.weight',
    'bert.bert.bert_encoder.layers.23.output.dense.weight',
